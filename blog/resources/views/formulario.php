...
<!-- <script type="text/javascript" src="../resources/assets/js/script_formulario.js"></script> -->
<!-- <script src="{{ URL::asset('js/script_formulario.js') }}"></script> -->
<script src="<?php url('/js/script_formulario.js') ?>"></script>
